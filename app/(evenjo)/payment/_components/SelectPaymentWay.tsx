...
const SelectPaymentWay = ({
  ...
  return (
    <div>
      {selectedMethod === "" && (
        <>
          <span className=" text-[24px] font-bold">Select payment method</span>
          <form action="">
            <div className="w-full p-2 rounded-lg shadow flex flex-col items-center justify-center gap-2 ">
              <label className="inline-flex justify-between bg-neutral-1000 w-full items-center rounded-lg p-2 border border-transparent has-checked:border-neutral-100  has-checked:bg-neutral-500 has-checked:font-bold hover:bg-neutral-500 transition-all cursor-pointer has-checked:transition-all has-checked:duration-500 duration-500 relative [&amp;_p]:has-[:checked]:translate-y-0 [&amp;_p]:has-[:checked]:transition-transform [&amp;_p]:has-[:checked]:duration-500 [&amp;_p]:has-[:checked]:opacity-100 overflow-hidden">
      ...
      {selectedMethod !== "" && (
        <FinalCombo totalPrice={totalPrice} ServicePrice={ServicePrice} />
      )}
    </div>
  );
};

export default SelectPaymentWay;
